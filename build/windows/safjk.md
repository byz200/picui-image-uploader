...
|»»» expired_at|string¦null|false|none||到期时间，可能为null|
|»»» created_at|string|true|none||创建时间|
...
|» message|string|true|none||none|
|» data|object|true|none||none|
|»» trade_no|string|true|none||系统订单号|
...
|» data|object|true|none||none|
|»» trade_no|string|true|none||订单号|
|»» amount|integer|true|none||实付金额(分)|
|»» deduct_amount|integer|true|none||抵扣金额(分)|
|»» snapshot|object|true|none||套餐快照|
|»»» name|string|true|none||套餐名称|
|»»» intro|string|true|none||套餐简介|
|»»» features|[string]|true|none||套餐权益|
...
|»» pay_method|string|true|none||支付方式|
|»» status|string|true|none||状态|
|»» paid_at|string|true|none||支付时间，可能为null|
|»» canceled_at|null|true|none||取消时间，可能为null|
|»» created_at|string|true|none||创建时间|
|»» coupon|object|true|none||优惠券信息，可能为null|
...
|Authorization|header|string| 否 |none|
|body|body|object| 否 |none|
|» platform|body|string| 是 |支付平台|
|» channel|body|string| 是 |支付渠道|
|» method|body|string| 是 |支付方法|
...
|»»» id|integer|true|none||none|
|»»» name|string|true|none||none|
|»»» last_used_at|string¦null|true|none||none|
|»»» expires_at|string¦null|true|none||none|
...
|Authorization|header|string| 否 |none|
|body|body|object| 否 |none|
|» name|body|string| 是 |令牌名称|
|» abilities|body|string| 是 |权限|
|» expires_at|body|string| 否 |到期时间(yyyy-MM-dd HH:mm:ss)|
...
```json
{
    ...
    "data": {
        "name": "123",
        "token": "5|ll0yN65FmPPPur9FY8MmTqjiqvnIGHaDnoDHuj3m06ed63e9"
    },
    "time": 1734919937
}
```
...
|»»  background_url|string|true|none||背景图片|
...
|»»» language|string|true|none||默认语言|
|»»» show_original_photos|boolean|true|none||是否显示原始图片|
|»»» encode_copied_url|string|true|none||复制链接时对URL进行编码|
|»»» auto_upload_after_select|string|true|none||选择图片后立刻上传|
|»»» upload_button_action|string|true|none||上传按钮点击动作|
...
```json
{
    "language": "occaecat nostrud",
    "show_original_photos": false,
    "encode_copied_url": true,
    "auto_upload_after_select": false,
    "upload_button_action": "veniam in nisi Lorem",
...
|» show_original_photos|body|boolean| 否 |none|
|» encode_copied_url|body|boolean| 否 |none|
|» auto_upload_after_select|body|boolean| 否 |none|
|» upload_button_action|body|string| 否 |上传动作|
|» default_storage_id|body|string| 否 |默认储存ID|
...
```yaml
background: file:///Users/xxb/Downloads/bg.jpg
...
|Authorization|header|string| 否 |none|
|body|body|object| 否 |none|
|» background|body|string(binary)| 否 |none|
...
```json
{
    ...
    "message": "successful",
    "data": {
        "background_url": "http://127.0.0.1:8000/storage/backgrounds/g31Oyy1oiZyqa8RHIX9ixu81CdXwn8oceLlba9GX.jpg"
    },
    "time": 1756685092
}
```
...
|per_page|query|integer| 否 |每页展示数量|
|q|query|string| 否 |筛选关键字|
|order|query|string| 否 |排序方式，newest=最新，oldest=最早，most_liked=最受欢迎，least_liked=最少点赞|
|tags|query|string| 否 |标签过滤，支持逗号分隔的多个标签|
|has_tags|query|string| 否 |是否只显示有标签的图片|
|Accept|header|string| 否 |none|
        ...
        "data": [
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 13345.571289062,
                "width": 3375,
                "height": 6000,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/e17f1a1233b7ec301b6ed4d9a5376283.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/e17f1a1233b7ec301b6ed4d9a5376283.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 13912.427734375,
                "width": 6000,
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/2b37dea6ba7b537f5c39c13b6fada263.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/2b37dea6ba7b537f5c39c13b6fada263.jpg",
                "tags": [
                    {
                        "id": 1,
                        "name": "人文"
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 9266.9794921875,
                "width": 6000,
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/a453fc1e623eb1d26a22d11531449392.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/a453fc1e623eb1d26a22d11531449392.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 11030.090820312,
                "width": 3375,
                "height": 6000,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/90b7b6c5c592f31087b60963ae3a27df.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/90b7b6c5c592f31087b60963ae3a27df.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 13901.565429688,
                "width": 3375,
                "height": 6000,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/07eb365666389a19e7732b851f3ef184.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/07eb365666389a19e7732b851f3ef184.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 14630.853515625,
                "width": 6000,
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/42f363c0234e78b98d8ac84efdc41b3e.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/42f363c0234e78b98d8ac84efdc41b3e.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 11220.440429688,
                "width": 3375,
                "height": 6000,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/d5c158654fbfdad3e6de20016c2c42e9.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/d5c158654fbfdad3e6de20016c2c42e9.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 13374.372070312,
                "width": 6000,
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/dbeddfdaeff86b331153f5df93cb24d9.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/dbeddfdaeff86b331153f5df93cb24d9.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 12847.366210938,
                "width": 3375,
                "height": 6000,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/ec000ad59eb03ca4b0d41cc6888ea095.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/ec000ad59eb03ca4b0d41cc6888ea095.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 11755.181640625,
                "width": 6000,
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/53dcd41b95ede16beebe5b2cc33deed4.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/53dcd41b95ede16beebe5b2cc33deed4.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 12945.001953125,
                "width": 6000,
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/ce8f50658745d7f276dcb652448d36da.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/ce8f50658745d7f276dcb652448d36da.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 11134.387695312,
                "width": 3375,
                "height": 6000,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/4b75dfcf7febf0cc3f833c098dfa6ac9.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/4b75dfcf7febf0cc3f833c098dfa6ac9.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 12924.540039062,
                "width": 6000,
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/56d0ee0acc10c86d55cbe4330821159a.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/56d0ee0acc10c86d55cbe4330821159a.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "height": 6000,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/9a6ca5c99e8879145d27bc8a40e5ff27.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/9a6ca5c99e8879145d27bc8a40e5ff27.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 12009.307617188,
                "width": 6000,
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/84abbaf4456aa8792dc1dab6c5b48763.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/84abbaf4456aa8792dc1dab6c5b48763.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 14251.749023438,
                "width": 6000,
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/53f74e2a125a1a751cc98447f2e2594b.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/53f74e2a125a1a751cc98447f2e2594b.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "height": 3360,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/d1ffcfd12f1772c3b64421f7b523dc9c.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/d1ffcfd12f1772c3b64421f7b523dc9c.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/989d25c0917196ff09345cbe61c09e80.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/989d25c0917196ff09345cbe61c09e80.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 12027.499023438,
                "width": 3375,
                "height": 6000,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/c342777f62e5db0bbcd3ccb7cf8d0d26.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/c342777f62e5db0bbcd3ccb7cf8d0d26.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "intro": "",
                "extension": "jpg",
                "size": 12053.090820312,
                "width": 6000,
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/db6f792ace93e1a4ac1b755fbe1d3367.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/db6f792ace93e1a4ac1b755fbe1d3367.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "height": 9047,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/cd30c6a51bd2a602c678a9e92bb5b0fe.png",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/cd30c6a51bd2a602c678a9e92bb5b0fe.png",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "height": 200,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/c73703a298aef082c8d12b16ce7cd54c.png",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/c73703a298aef082c8d12b16ce7cd54c.png",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            {
                "id": 7,
                "name": "剪贴板 2025-04-30 下午 5.01.58",
                "intro": "",
                "extension": "png",
                "size": 228.8720703125,
                "width": 1920,
                "height": 1055,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/570d541b05557242e850c68d50453c96.png",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/570d541b05557242e850c68d50453c96.png",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            {
                "id": 8,
                "name": "Snipaste_2025-04-30_10-30-01",
                "intro": "",
                "extension": "PNG",
                "size": 6.62109375,
                "width": 374,
                "height": 160,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/65fcee6ec88e321028adf1121019e27b.PNG",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/65fcee6ec88e321028adf1121019e27b.PNG",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "height": 150,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/03960b363b626697cec5e9a2572aeddd.png",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/03960b363b626697cec5e9a2572aeddd.png",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "height": 3375,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250728/7f5b9f969d34e37b971df9deb38c4a16.jpg",
                "public_url": "http://127.0.0.1:8000/uploads/20250728/7f5b9f969d34e37b971df9deb38c4a16.jpg",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
            ...
            },
            {
                ...
                "height": 9047,
                "is_liked": false,
                "thumbnail_url": "http://127.0.0.1:8000/storage/thumbnails/20250703/cd30c6a51bd2a602c678a9e92bb5b0fe.webp",
                "public_url": "http://127.0.0.1:8000/uploads/20250703/cd30c6a51bd2a602c678a9e92bb5b0fe.webp",
                "tags": [],
                "user": {
                    "id": 1,
                    "name": "admin",
...
GET /explore/photos/popular-tags

### 请求参数

|名称|位置|类型|必选|中文名|说明|
|---|---|---|---|---|---|
|limit|query|number| 否 ||返回数量限制，默认10，最大50|
|Accept|header|string| 否 ||none|
|Authorization|header|string| 否 ||none|
    ...
    "data": [
        {
            "id": 8,
            "name": "2",
            "created_at": "2025-08-29T04:34:46.000000Z",
            "updated_at": "2025-08-29T04:34:46.000000Z",
            "photos_count": 5
        },
        {
            "id": 12,
            "name": "1",
            "created_at": "2025-08-30T02:56:12.000000Z",
            "updated_at": "2025-08-30T02:56:12.000000Z",
            "photos_count": 3
        },
        {
            "id": 2,
            "name": "23123",
            "created_at": "2025-08-28T07:43:23.000000Z",
            "updated_at": "2025-08-28T07:43:23.000000Z",
            "photos_count": 2
        },
        {
            "id": 14,
            "name": "3",
            "created_at": "2025-08-30T03:19:07.000000Z",
            "updated_at": "2025-08-30T03:19:07.000000Z",
            "photos_count": 2
        },
        {
            "id": 1,
            "name": "qwe",
            "created_at": "2025-08-27T23:59:50.000000Z",
            "updated_at": "2025-08-27T23:59:50.000000Z",
            "photos_count": 1
        },
        {
            "id": 3,
            "name": "21312",
            "created_at": "2025-08-28T08:03:59.000000Z",
            "updated_at": "2025-08-28T08:03:59.000000Z",
            "photos_count": 1
        },
        {
            "id": 4,
            "name": "13",
            "created_at": "2025-08-28T08:49:39.000000Z",
            "updated_at": "2025-08-28T08:49:39.000000Z",
            "photos_count": 1
        },
        {
            "id": 5,
            "name": "2213",
            "created_at": "2025-08-29T00:47:49.000000Z",
            "updated_at": "2025-08-29T00:47:49.000000Z",
            "photos_count": 1
        },
        {
            "id": 6,
            "name": "333",
            "created_at": "2025-08-29T00:51:33.000000Z",
            "updated_at": "2025-08-29T00:51:33.000000Z",
            "photos_count": 1
        },
        {
            "id": 9,
            "name": "1515",
            "created_at": "2025-08-29T04:37:30.000000Z",
            "updated_at": "2025-08-29T04:37:30.000000Z",
            "photos_count": 1
        }
    ],
    "time": 1756548549
...
|»» photos_count|integer|true|none||none|
|» time|integer|true|none||none|
...
```json
{
    ...
    "data": {
        ...
        "links": {
            "first": "http://127.0.0.1:8000/api/v2/explore/albums/1/photos?page=1",
            "last": "http://127.0.0.1:8000/api/v2/explore/albums/1/photos?page=1",
            "prev": null,
            "next": null
        },
        "meta": {
            ...
            "links": [
                ...
                {
                    "url": "http://127.0.0.1:8000/api/v2/explore/albums/1/photos?page=1",
                    "label": "1",
                    "active": true
                },
                {
            ...
            "path": "http://127.0.0.1:8000/api/v2/explore/albums/1/photos",
            "per_page": 20,
            "to": 1,
            "total": 1
        }
...
```json
{
    ...
    "data": {
        ...
        "links": {
            "first": "http://127.0.0.1:8000/api/v2/shares/9326c1a678fa4dec9b1678ee4fa83c62/photos?page=1",
            "last": "http://127.0.0.1:8000/api/v2/shares/9326c1a678fa4dec9b1678ee4fa83c62/photos?page=2",
            "prev": null,
            "next": "http://127.0.0.1:8000/api/v2/shares/9326c1a678fa4dec9b1678ee4fa83c62/photos?page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            ...
            "links": [
                ...
                {
                    "url": "http://127.0.0.1:8000/api/v2/shares/9326c1a678fa4dec9b1678ee4fa83c62/photos?page=1",
                    "label": "1",
                    "active": true
                },
                {
                    "url": "http://127.0.0.1:8000/api/v2/shares/9326c1a678fa4dec9b1678ee4fa83c62/photos?page=2",
                    "label": "2",
                    "active": false
                },
                {
            ...
            "path": "http://127.0.0.1:8000/api/v2/shares/9326c1a678fa4dec9b1678ee4fa83c62/photos",
            "per_page": 15,
            "to": 15,
            "total": 26
        },
...
|»»» is_liked|boolean|true|none||none|
|»»» thumbnail_url|string|true|none||none|
|»»» public_url|string|true|none||none|
...
```
{"status":"success","message":"successful","time":1720427678}
```
...
```json
{
    ...
    "data": {
        "app": {
            ...
            "user_email_register_verify": false,
            "user_phone_register_verify": false,
            "enable_site": true,
            "enable_explore": true,
            "timestamp": 1749002578,
            "is_logged_in": false,
            "photo_count": 6,
            "photo_size": 344.57,
            "countries": [
        ...
        "site": {
            ...
            "custom_css": "html,body {height:100px}",
            "custom_js": "alert(123)",
            "user_login_types": [
                "email",
                "phone",
...
|»»» currency|string|true|none||系统货币|
|»»» icp_no|string|true|none||备案号|
|»»» enable_registration|boolean|true|none||是否开启注册|
|»»» guest_upload|boolean|true|none||是否允许游客上传|
|»»» user_email_verify|boolean|true|none||是否启用邮箱注册|
|»»» user_phone_verify|boolean|true|none||是否启用手机号注册|
|»»» user_email_register_verify|boolean|true|none||用户注册是否需要验证邮箱|
|»»» user_phone_register_verify|boolean|true|none||用户注册是否需要验证手机号|
|»»» enable_site|boolean|true|none||是否启用站点|
|»»» enable_explore|boolean|true|none||是否启用广场|
...
|»»» id|integer|false|none||驱动ID|
|»»» name|string|false|none||名称|
|»»» intro|string|false|none||简介|
|»»» platform|string|true|none||支付平台|
|»»» channels|[string]|true|none||支付通道|
|»»» methods|[string]|true|none||支付方法|
|» time|integer|true|none||none|
...
|» is_remove_exif|body|boolean| 否 ||是否移除 exif 信息|
|» intro|body|string| 否 ||描述|
...
|» phone|body|string| 是 ||手机号|
|» country_code|body|string| 是 ||国家|
|» captcha|body|string| 是 ||图形验证码|
|» captcha_key|body|string| 是 ||图形验证码key|
...
```json
{
    ...
    "data": {
        "sensitive": false,
        "key": "",
        "img": "data:image/jpeg;base64,"
    },
    "time": 1742176403
}
```
...
|» message|string|true|none||none|
|» data|object|true|none||none|
|»» token_name|string|true|none||token名称|
|»» abilities|[string]|true|none||权限列表，如果只有一个元素“*”表示拥有所有权限|
|»» last_used_at|string|true|none||最后使用时间|
|»» expires_at|null|true|none||到期时间，可能为null|
|» time|integer|true|none||none|

## GET 系统支持的所有令牌权限

GET /token_permissions
        ...
        "permissions": [
            {
                ...
                "label": "读取用户资料",
                "detail": "允许读取用户个人资料，包括昵称、头像、邮箱、手机号等基本信息。",
                "category": "user"
            },
            {
                "value": "user:profile:write",
                "label": "更新用户资料",
                "detail": "允许修改用户个人资料，包括更新昵称、头像、绑定/解绑邮箱和手机号。",
                "category": "user"
            },
            {
                "value": "user:token:read",
                "label": "查看个人令牌",
                "detail": "允许查看用户创建的所有访问令牌列表，包括令牌名称、创建时间和过期时间。",
                "category": "user"
            },
            {
                "value": "user:token:write",
                "label": "管理个人令牌",
                "detail": "允许创建新的访问令牌或删除现有令牌，管理令牌的权限范围和有效期。",
                "category": "user"
            },
            {
                "value": "user:group:read",
                "label": "查看用户角色组",
                "detail": "允许查看用户所属的角色组信息，包括组名称、权限等级和加入时间。",
                "category": "user"
            },
            {
                "value": "user:group:write",
                "label": "管理用户角色组",
                "detail": "允许管理用户角色组，包括创建、修改或删除角色组，以及调整组内权限。",
                "category": "user"
            },
            {
                "value": "user:capacity:read",
                "label": "查看用户容量",
                "detail": "允许查看用户存储容量信息，包括总容量、已使用容量和各类资源占用情况。",
                "category": "user"
            },
            {
                "value": "user:capacity:write",
                "label": "管理用户容量",
                "detail": "允许管理用户存储容量，包括扩容、调整限制和重置配额。",
                "category": "user"
            },
            {
                "value": "user:album:read",
                "label": "查看相册",
                "detail": "允许查看用户创建的相册列表和相册内容，包括名称、创建时间和包含照片。",
                "category": "user"
            },
            {
                "value": "user:album:write",
                "label": "管理相册",
                "detail": "允许创建、编辑和删除相册，调整相册属性如名称、封面和访问权限。",
                "category": "user"
            },
            {
                "value": "user:photo:read",
                "label": "查看照片",
                "detail": "允许查看用户上传的照片，包括照片信息、元数据和预览图。",
                "category": "user"
            },
            {
                "value": "user:photo:write",
                "label": "管理照片",
                "detail": "允许上传、编辑和删除照片，修改照片属性如标题、描述和标签。",
                "category": "user"
            },
            {
                "value": "user:share:read",
                "label": "查看分享",
                "detail": "允许查看用户创建的分享内容列表，包括分享链接、访问权限和过期设置。",
                "category": "user"
            },
            {
                "value": "user:share:write",
                "label": "管理分享",
                "detail": "允许创建新的分享或管理现有分享，包括修改分享设置和删除分享。",
                "category": "user"
            },
            {
                "value": "user:ticket:read",
                "label": "查看工单",
                "detail": "允许查看用户提交的工单列表和工单详情，包括状态和回复内容。",
                "category": "user"
            },
            {
                "value": "user:ticket:write",
                "label": "管理工单",
                "detail": "允许创建新工单、回复工单或关闭工单，管理工单优先级和标签。",
                "category": "user"
            },
            {
                "value": "user:order:read",
                "label": "查看订单",
                "detail": "允许查看用户的订单历史和订单详情，包括订单状态、支付信息和商品内容。",
                "category": "user"
            },
            {
                "value": "user:order:write",
                "label": "管理订单",
                "detail": "允许创建新订单、取消订单或申请退款，管理订单相关操作。",
                "category": "user"
            },
            {
                "value": "oauth:read",
                "label": "查看OAuth信息",
                "detail": "允许查看用户的OAuth绑定信息，包括已绑定的第三方账号列表和授权状态。",
                "category": "oauth"
            },
            {
                "value": "oauth:write",
                "label": "管理OAuth绑定",
                "detail": "允许管理OAuth绑定，包括绑定新的第三方账号或解除现有绑定。",
                "category": "oauth"
            },
            {
                "value": "explore:read",
                "label": "浏览探索内容",
                "detail": "允许浏览和查看探索页面的公开内容，包括推荐内容和热门分享。",
                "category": "explore"
            },
            {
                "value": "explore:write",
                "label": "管理探索互动",
                "detail": "允许在探索内容上进行互动，如点赞、评论或收藏公开分享的内容。",
                "category": "explore"
            },
            {
                "value": "upload:write",
                "label": "上传图片",
                "detail": "允许上传新图片到系统，包括单张上传或批量上传，自动处理图片格式。",
                "category": "upload"
            },
            {
                "value": "basic",
                "label": "基础权限",
                "detail": "基础访问权限，包括查看系统配置、公告、页面和套餐信息等公共API的访问权限。此权限是所有令牌的默认权限。",
                "category": "basic"
            }
        ],
        "groups": {
...
|»»» user|object|true|none||none|
|»»»» 用户资料|[string]|true|none||none|
|»»»» 访问令牌|[string]|true|none||none|
|»»»» 角色组|[string]|true|none||none|
|»»»» 存储容量|[string]|true|none||none|
|»»» content|object|true|none||none|
|»»»» 相册管理|[string]|true|none||none|
|»»»» 照片管理|[string]|true|none||none|
|»»»» 内容分享|[string]|true|none||none|
|»»»» 内容上传|[string]|true|none||none|
|»»» service|object|true|none||none|
|»»»» 工单服务|[string]|true|none||none|
|»»»» 订单管理|[string]|true|none||none|
|»»» integration|object|true|none||none|
|»»»» OAuth集成|[string]|true|none||none|
|»»»» 内容探索|[string]|true|none||none|
|»»» basic|object|true|none||none|
|»»»» 基础功能|[string]|true|none||none|
|» time|integer|true|none||none|
...
|名称|位置|类型|必选|中文名|说明|
|---|---|---|---|---|---|
|key|path|string| 是 ||访问key，若后台未设置则可为空|
|Accept|header|string| 否 ||none|
|Authorization|header|string| 否 ||none|
...
|»»» share_count|integer|true|none||分享数量|
|»»» today_photo_count|integer|true|none||今日图片数量|
|»»» today_album_count|integer|true|none||今日相册数量|
|»»» today_user_count|integer|true|none||今日用户数量|
|»»» today_share_count|integer|true|none||今日分享数量|
|»» orders|object|true|none||none|
|»»» total_amount|integer|true|none||总订单额|
|»»» today_amount|integer|true|none||今日订单额|
|»»» yesterday_amount|integer|true|none||昨日订单额|
|»»» week_amount|integer|true|none||本周订单额|
|»»» month_amount|integer|true|none||本月订单额|
|»» system|object|true|none||none|
|»»» os|string|true|none||操作系统|
|»»» environment|string|true|none||运行环境|
|»»» php_version|string|true|none||php 版本|
|»»» memory_limit|string|true|none||最大内存限制|
|»»» max_upload_filesize|string|true|none||最大上传文件大小|
|»»» max_post_size|string|true|none||最大 POST 数据|
|»»» software_version|string|true|none||软件版本号|
|» time|integer|true|none||none|
